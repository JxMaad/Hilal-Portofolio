      ...
      <section id="projects" className="pt-24 pb-20 bg-[#1f252d]">
        <div className="container">
          ...
          <div className="mb-12 lg:w-1/3 border border-primary rounded-md shadow" data-aos="fade-up" data-aos-duration="1000">
              ...
              <p className="font-extralight leading-relaxed tracking-[2px] px-2">I made this project as a final assignment from my school to create something useful for the school. Finally I thought about creating this information system.</p>
            ...
            <div className="mb-12 lg:w-1/3 border border-primary rounded-md shadow">
              ...
              <p className="font-extralight leading-relaxed tracking-[2px] px-2">This is my class website that I have created with my friends, this website aims to introduce our class to visitors as well as a place for collecting data and student projects.</p>
            ...
            <div className="mb-12 lg:w-1/3 border border-primary rounded-md shadow" data-aos="fade-up" data-aos-duration="1000">
              <div className="rounded-md overflow-hidden">
                <img src="./UIKA-3.png" alt="foto-kelas" width="w-full" />
              </div>
